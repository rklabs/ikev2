...
AsyncIOHandler::AsyncIOHandler(int noOfEvents,
...
int AsyncIOHandler::addFd(int fd) {
    TRACE();
    auto inputEvent_ = sharedPtrEpollEvent(new struct epoll_event);
